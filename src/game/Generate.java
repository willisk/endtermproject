...
public class Generate {
   ...
   static String propFileName = "level.properties";
   ...
   static InputStream paramStream;
   ...
   static long read(){
      try {
         //InputStream fileInput = new FileInputStream(new File(paramFileName));
         param.load(paramStream);
         paramStream.close();
   ...
   static void write(long seed){
      ...
      prop.setProperty("Theme", gameTheme);
      try {
         //FileOutputStream outFile = new FileOutputStream(new File(propFileName));
         FileOutputStream outFile = new FileOutputStream( new java.io.File(propFileName+".properties") );
   ...
   public static void newMaze(String file, InputStream parameters, String theme){
        printField=false;
        propFileName=file;
